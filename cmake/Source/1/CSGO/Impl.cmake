if (CMAKE_SYSTEM_NAME MATCHES "Darwin")
	message(FATAL_MESSAGE "Mac is not supported.")
...
elseif(WIN32) 
    # Or we use someelse method to determine whether this is windows?
	# because we even don't have any idea to determine whether it is x64 build.
...
#        )
set(PROTO_SRCS
    ${HL2SDK_PATH}/public/engine/protobuf/netmessages.pb.cc
    ${HL2SDK_PATH}/public/game/shared/csgo/protobuf/cstrike15_usermessages.pb.cc
)
set(PROTO_HDRS
    ${HL2SDK_PATH}/public/engine/protobuf/netmessages.pb.h
    ${HL2SDK_PATH}/public/game/shared/csgo/protobuf/cstrike15_usermessages.pb.h
)
...
target_include_directories(steam_api INTERFACE
    ${HL2SDK_PATH}/public
    ${HL2SDK_PATH}/public/steam
)
if (WIN32)
    target_link_libraries(steam_api INTERFACE steam_api${LIB_STATIC_SUFFIX}${LIB_STATIC_EXT})
endif()
#target_link_libraries(steam_api INTERFACE steam_api${LIB_STATIC_SUFFIX}${LIB_STATIC_EXT})
...
#
add_library(csgo_sdk INTERFACE)
target_include_directories(csgo_sdk INTERFACE
    ${HL2SDK_PATH}/common
    ${HL2SDK_PATH}/public
...
target_link_libraries(csgo_sdk INTERFACE tier0 tier1 vstdlib mathlib interfaces hl2sdk_protobuf_csgo)